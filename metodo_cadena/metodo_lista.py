...
#agregando un elemento a la lista en un indice o posiscion especifico
...
#ordenando la lista de forma ascendente (si usamos el parametro reverse=True lo ordena en reversa), solo enteros
lista.sort()
